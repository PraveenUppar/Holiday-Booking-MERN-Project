  ...
  return (
    <>
      <div className=" grid gap-4 grid-col-3 mt-3 md:grid-cols-4 lg:grid-cols-6 ">
        <label className=" cursor-pointer flex items-center gap-2 border rounded-2xl p-4">
          <input
            type="checkbox"
        ...
        <label className=" cursor-pointer flex items-center gap-2 border rounded-2xl p-4">
          ...
          <span className="font-semibold">Smoke alarm</span>
        </label>
        <label className="  cursor-pointer flex items-center gap-2 border rounded-2xl p-4">
          <input
            type="checkbox"
          ...
          <span className="font-semibold">First aid kit</span>
        </label>
        <label className="  cursor-pointer flex items-center gap-2 border rounded-2xl p-4">
          <input
            type="checkbox"
            checked={selected.includes("5 Star rating")}
            name="5 Star rating"
            onChange={handleClick}
          ></input>
          <svg
        ...
        <label className=" cursor-pointer flex items-center gap-2 border rounded-2xl p-4">
          <input
            type="checkbox"
            checked={selected.includes("Football Turf")}
            name="Football Turf"
            onChange={handleClick}
          ></input>
          <svg
          ...
          <span className="font-semibold">Football Turf</span>
        </label>
      </div>
    </>
  );
