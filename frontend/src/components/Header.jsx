...
const Header = () => {
  const { setUserInfo, userInfo, setUser } = useContext(UserContext);
    ...
    <div>
      <header className="flex justify-evenly items-center">
        <Link to={"/"} className="flex items-center gap-2">
          ...
          <span className="font-bold text-4xl ">AFrame</span>
        </Link>
        <div className="flex gap-3 border items-center border-gray-300 rounded-full py-2 px-4 shadow-md shadow-gray-300">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <>
          {email && (
            <div className="flex border items-center border-gray-300 rounded-full shadow-md shadow-gray-300">
              <Link to={"/account"}>
              ...
              <>|</>
              <Link onClick={logout}>
                <div className="flex py-2 px-4 gap-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
